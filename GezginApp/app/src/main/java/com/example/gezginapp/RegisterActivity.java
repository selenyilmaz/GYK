...
public class RegisterActivity extends AppCompatActivity {
    ...
    private Button yeniKayitButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        newUserMail = (EditText) findViewById(R.id.yeniEmail);
        newUserPassword = (EditText) findViewById(R.id.yeniParola);
        newUserPasswordCheck = (EditText) findViewById(R.id.yeniParolaKontrol);
        yeniKayitButton = (Button) findViewById(R.id.yeniKayit);

        //nesne ile işlemleri gerçekleştirebilmek için
        mAuth = FirebaseAuth.getInstance();

        yeniKayitButton.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    } //fonksiyonlar onCreate dışında tanımlanır
