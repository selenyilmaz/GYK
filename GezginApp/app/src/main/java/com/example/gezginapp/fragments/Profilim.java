...
import com.example.gezginapp.AddPhotoActivity;
...
public class Profilim extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        fotoEkle = profileView.findViewById(R.id.foto_ekle);
        ...
        fotoEkle.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent fotoIntent = new Intent(getContext(), AddPhotoActivity.class);
